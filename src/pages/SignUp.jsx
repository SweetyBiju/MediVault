...
const SignUp = () => {
    ...
    switch (step) {
      ...
      case 2:
        if (formData.role === 'patient') {
          ...
          return formData.licenseNumber && formData.specialty && formData.hospitalAffiliation;
        }
      case 3:
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.role === 'patient') {
      ...
      userData.conditions = formData.conditions;
    } else {
      userData.licenseNumber = formData.licenseNumber;
      userData.specialty = formData.specialty;
      userData.hospitalAffiliation = formData.hospitalAffiliation;
    }
              ...
              {currentStep === 2 && (
                ...
                >
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">
                    {formData.role === 'patient' ? 'Health Information' : 'Professional Information'}
                  </h3>
                ...
                >
                  ...
                  <div className="flex items-start space-x-3">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded mt-1"
                    />
                    <label htmlFor="enableTutorial" className="text-sm text-gray-700">
                      Show me a guided tutorial after registration (recommended)
                    </label>
                  </div>
