...
import { Eye, EyeOff, Mail, Lock, Heart, AlertCircle,User,Stethoscope } from 'lucide-react';
      ...
      <div className="relative max-w-md w-full space-y-8">
        ...
        >
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">Sign in to access your secure health records</p>
          </div>
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">Don't have an account? <Link to="/signup" className="font-medium text-blue-600 hover:text-blue-500">Sign up now</Link></p>
            </div>
          </form>
        </motion.div>
      </div>
